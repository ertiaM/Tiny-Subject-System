...
<div class="container">
    <div class="cap">Show Selected Courses</div>
    <table class="course">
        <tr class="title">
            <th>Course Name</th>
            <th>Class Date</th>
        ...
        <c:forEach items="${selectedCourseList}" var="course">
            <tr class="info">
                <th>${course.course}</th>
                ...
                <th>${course.major}</th>
                <th>
                    <form action="${pageContext.request.contextPath}/account/quitCourse" method="post">
                        <input type="hidden" name="course_id" value="${course.course_id}">
                        <input class="button" type="submit" value="quit"><br>
                    </form>
                </th>
            </tr>
        </c:forEach>
