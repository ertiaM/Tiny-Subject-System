...
<div class="container">
    <div class="cap">
        ...
        <form class="formmer" name="accountForm" action="${pageContext.request.contextPath}/account/search" method="post">
            Course Name: <input class="input" type="text" name="course_name"><br>
            <input class="search-button" type="submit" value="Search"><br>
        </form>
    </div>
    <table class="course">
        <tr class="title">
        ...
        <c:forEach items="${courseList}" var="course">
            <tr class="info">
                ...
                <th>${course.major}</th>
                <th>
                    <form action="${pageContext.request.contextPath}/account/selectCourse" method="post">
